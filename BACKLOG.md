...
- Ticker tape banner for ads or other notifications
- Mobile-friendly with ability to link from home screen
- Add dummy show data (from r/jambands Reddit post)
- Link to Phantasy Tour for importing show attendance lists
